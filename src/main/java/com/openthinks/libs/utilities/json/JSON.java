...
public final class JSON {
	...
	public static final String stringify(JSONElement root) {
		if (root.isArray()) {
			return stringify(root.asArray());
		} else {
			return stringify(root.asObject());
		}
	}
	...
	public static final String stringify(JSONObject object) {
		...
		while (keyIter.hasNext()) {
			...
			if (element.isNull()) {
				...
				buffer.append(JSONToken.DOUBLE_QUOTE).append(element.value()).append(JSONToken.DOUBLE_QUOTE);
