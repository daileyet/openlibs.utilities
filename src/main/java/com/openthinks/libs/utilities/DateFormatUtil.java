 ...
 * Reason: {@link DateFormat} has thread issue in multi-thread situation, use {@link ThreadLocal} to
 * make sure each thread use one instance of {@link DateFormat}. <br>
 * 
...
public final class DateFormatUtil {
  ...
  /**
   * 
   * getDateFormat:get or create {@link DateFormat} which bind to current thread. <br>
   * 
  ...
  public static final Date parse(String pattern, String dateString, TimeZone timeZone)
